...
const dev_orders = 'https://mkc1x877vb.execute-api.us-east-2.amazonaws.com/orders-dev';
...
export const orderRequest = async (endpoint: string, options: RequestInit = {}) => {
  const url = `${dev_orders}${endpoint}`;
